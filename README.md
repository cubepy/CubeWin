...
گروه Patterniha، همچنان تحت لایسنس [GPL-3.0](LICENSE) مشابه پروژهٔ اصلی. ورود با کد یک‌بارمصرف تلگرام
(دقیقاً مثل اپ اندروید و کلاینت ویندوزی/WPF کیوب‌وی‌پی‌ان) به‌عنوان گام بعدی روی همین ری‌برند برنامه‌ریزی شده است.
