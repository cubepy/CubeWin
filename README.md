# کیوب‌وی‌پی‌ان دسکتاپ (ویندوز)

این کلاینت دسکتاپ ویندوزی کیوب‌وی‌پی‌ان است — نسخه‌ای با توزیع خصوصی و برند اختصاصی، ساخته‌شده بر پایهٔ
[UAC SNI Spoofer Windows](https://github.com/Floxu1/UAC-SNI-Spoofer-Windows) اثر Floxu1 و روش SNI-spoofing
گروه Patterniha، همچنان تحت لایسنس [GPL-3.0](LICENSE) مشابه پروژهٔ اصلی. این کلاینت فقط با کانفیگ‌های
حساب کاربری شما کار می‌کند — هیچ کانفیگ رایگان یا پیشنهادی همراه برنامه نیست. ورود با کد یک‌بارمصرف تلگرام
(دقیقاً مثل اپ اندروید و کلاینت ویندوزی/WPF کیوب‌وی‌پی‌ان) از بخش «ورود به حساب» در صفحهٔ کانفیگ‌ها انجام می‌شود.
